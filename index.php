...
<form method="post" id="sign-up-form">
	...
	<fieldset>
		...
		<div id="extended-profile">
			...
			<label for="sign-up-url">URL:</label><input type="url" url="url" id="sign-up-url"/>
			<label for="sign-up-twitter">Twitter Handle:</label><input type="text" twitter="twitter" id="sign-up-twitter"/>
		</div>
